...
class ReversalPatternsFragment : Fragment(), PatternAdapter.OnPatternClickListener {
    private lateinit var binding: FragmentReversalPatternsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.patternsLiveData.observe(viewLifecycleOwner) { patterns ->
            binding.rvReversePatterns.adapter = PatternAdapter(
                this,
                patterns,
                requireContext()
            )
